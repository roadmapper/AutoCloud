...
public interface SoundCloud2Client {
    //https://api-v2.soundcloud.com/users/17645122/track_likes/3040119?client_id=fDoItMDbsbZz8dY16ZzARCZmzgHBPotA&app_version=1479930743
    @PUT("/users/{userId}/track_likes/{trackId}?app_version=1517322608")
    ...
    @DELETE("/users/{userId}/track_likes/{trackId}?app_version=1517322608")
    Call<Response> unlikeTrack(@Path("userId") String userId, @Path("trackId") String trackId, @Query("client_id") String clientId);

    //{"track_urn":"soundcloud:tracks:389443545"}
    @POST("/me/play-history?app_version=1517322608")
